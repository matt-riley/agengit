...
/// Doctor check for a JS-extension agent (Pi): the extension is a generated
/// file rather than merged JSON config, so confirm the file exists, was written
/// by agit, and embeds the current agit binary path.

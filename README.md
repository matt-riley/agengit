...
`agit` is early, sharp-edged, and useful-in-progress. The CLI is currently `1.9.0`, and both the command output and on-disk format may change before a stable release. <!-- x-release-please-version -->
